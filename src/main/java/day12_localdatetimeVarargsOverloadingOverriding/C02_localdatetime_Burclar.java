...
public class C02_localdatetime_Burclar {
    public static void main(String[] args) {
//  /*       Tom 29 Ekim 1923 tarihinden 45 yil 8 ay 5 gun sonra dogdu.
//    //sonra     //  Veli 15 Eylul 1993 tarihinden 24 yil 2 ay 11 gun sonra dogdu.
...
////sonra//LocalDate dogVeli = LocalDate.of(1993,Month.SEPTEMBER,15).plusYears(24).plusMonths(2).plusDays(11);
...
//        System.out.println(ayniMi);
 /*
        ...
        LocalDateTime farkAlmanya = LocalDateTime.now(ZoneId.of("Asia/Tokyo"));
        LocalDateTime farkJapan = LocalDateTime.now(ZoneId.of("Europe/Berlin"));

        long fark = ChronoUnit.HOURS.between(farkAlmanya, farkJapan);
        ...
        System.out.println(dtf6.format(time2.plusHours(22)));//Normalde 10:48:00 eklenince 12:48:00
